-- ========================================
-- User API Keys Schema Extension
-- ========================================
-- 
-- This schema extends the existing Supabase user authentication system
-- to support per-user OpenRouter API keys for better cost attribution,
-- usage tracking, and security isolation.
--
-- INSTRUCTIONS:
-- 1. Run the main supabase-schema.sql first
-- 2. Then run this extension
-- 3. Update your application to use per-user keys
--
...
/*
-- Example: Create API key for existing user
-- Note: You'll need to create the actual OpenRouter key first using the key manager
